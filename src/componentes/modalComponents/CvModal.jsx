    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Abas de Navegação */}
          <div className='cv-modal__tabs' role='tablist' aria-label='Abas do Currículo'>
                    ...
                    <div key={item.id} className='cv-modal__experience-item'>
                      ...
                      >
                        ...
                        <p className='cv-modal__experience-company'> 
                          {item.company}{' '} 
                          <span className='cv-modal__experience-period'> {item.period} </span>
                        </p>
                        <FontAwesomeIcon
                          ...
                          >
                            ...
                            {Array.isArray(item.description) ? ( // Para verificar caso description não seja um array
                              item.description.map((desc, idx) => (
                                <p key={idx} className='cv-modal__experience-description'> 
                                  {desc} 
                                </p>
                              ))
                            ) : (
                            ...
                            {Array.isArray(item.abilities) ? ( // Para verificar caso description não seja um array
                              item.abilities.map((abili, ida) => (
                                <p key={ida} className='cv-modal__experience-description'>
                                  • {abili}
                                </p>
                              ))
                            ) : (
