  ...
  return (
    ...
    <footer className='footer'>
      ...
      <div className='footer__links-container' >
        ...
        <a className="footer__links--a" href='https://wa.me/11989157255' target='_blank' rel='noopener noreferrer'>
          <FontAwesomeIcon className="icons" icon={faWhatsapp} />
          <p>(11) 98915-7255</p>
        </a>

        {/* Link para o LinkedIn. */}
        <a className="footer__links--a" href='https://www.linkedin.com/in/lucasalvespinheiro/' target='_blank' rel='noopener noreferrer'>
          <FontAwesomeIcon className="icons" icon={faLinkedin} />
          <p>/lucasalvespinheiro</p>
        </a>
        
        {/* Link para o E-mail. */}
        <a className="footer__links--a" href='mailto:l.pinheiro.w@gmail.com'>
          <FontAwesomeIcon className="icons" icon={faEnvelope} />
          <p>l.pinheiro.w@gmail.com</p>
        </a>

        {/* Link para o Behance. */}
        <a className="footer__links--a" href='https://www.behance.net/raideri' target='_blank' rel='noopener noreferrer'>
          <FontAwesomeIcon className="icons" icon={faBehance} />
          <p>/raideri</p>
        </a>
        
        {/* Link para o GitHub. */}
        <a className="footer__links--a" href='https://github.com/RaideriSpace' target='_blank' rel='noopener noreferrer'>
