...
export const uiData = [
	{
		...
		img: connectTb,
		status: "Finalizado",
		tags: ["Notificação", "Storys", "Pefil", "Atualização Push", "Timeline", "Interativo", "Mobile"],
	...
	},
	{
		...
		img: todoTb,
		status: "Finalizado",
		tags: ["Push to Delete", "Adicionar Tarefa", "Excluir Tarefa", "Menu Push", "Mobile"],
		description:
			"Um aplicativo para teste de algumas ações como “Push” para deletar e menu lateral por push, muito usados nos aplicativos atualmente.",
	...
	},
	{
		...
		img: spotifyTb,
		status: "Finalizado",
		tags: ["Style Guide", "Login", "Galeria", "Play/Pause", "Design Interativo", "Mobile"],
	...
	},
	{
		...
		img: moveTb,
		status: "Finalizado",
		tags: ["LP", "Figma", "Wireframe", "Style Guide", "Orçamentação", "Mapa"],
		description:
			"Para aprimoramento pessoal, fiz a criação dessa Landing Page com base em um briefing de um site de mudanças que quer passar a sensação de segurança, simples e confiável.",
	...
	},
	{
		...
		img: barberShopTb,
		status: "Finalizado",
		tags: ["LP", "Figma", "Style Guide", "Design Interativo", "Carrossel", "Agenda"],
		description:
			"Para atender um briefing com estilo visual moderno e minimalista, com um toque de elegância, visa um público alvo com interesse em moda e estilo urbano. ",
	...
	},
	{
		...
		img: pixSumupTb,
		status: "Finalizado",
		tags: ["LP", "E-mail", "Figma", "Wireframe", "Style Guide", "Paletas", "Benchmark", "Pixel Perfect"],
		description:
			"Projeto proposto pela EBAC, realizei a junção das marcas SumUp e Pix, a fim de promover ao usuário da SumUp a nova forma de pagamento.",
	...
	},
	{
		...
		img: bikeAnjoTb,
		status: "Em Andamento",
		tags: ["LP", "Mobile", "Figma", "Wireframe", "Style Guide", "Design Interativo"],
		description:
			"Junto de outros voluntários, buscamos melhorar o design do site da Bike Anjo, com base em entrevistas com usuários para que seja mais agradável e funcional",
		link: "/",
	},
];
...
export const devData = [
	{
		...
		img: gamesTb,
		status: "Ajustando",
		tags: ["Front-End", "JavaScript", "HTML", "CSS", "Jogos"],
		description:
	...
	// },
	{
		...
		img: spotifywebTb,
		status: "Finalizado",
		tags: ["Fullstack", "JavaScript", "React", "Vite", "MongoDb", "CSS", "Git", "Express"],
	...
	},
	{
		...
		img: portfolioTb,
		status: "Em andamento",
		tags: ["Front-End", "JavaScript", "React", "Vite", "CSS", "HTML", "Git", "Framer Motion", "ESLint"],
		description:
	...
	},
	{
		...
		img: trsTb,
		status: "Finalizado",
		tags: ["Front-End", "HTML", "CSS", "JavaScript", "Bootstrap", "jQuery", "PHP", "EcmaScript"],
		description:
	...
	},
	{
		...
		img: pythonTb,
		status: "Finalizado",
		tags: ["Lógica", "Python", "IA", "DataScience", "Jupyter", "Machine Learning", "Chatbot"],
		description:
	...
	},
	{
		...
		img: contabancariaTb,
		status: "Finalizado",
		tags: ["Lógica", "TypeScript", "JavaScript", "Lógica de Programação", "CRUD"],
		description:
	...
	},
	{
		...
		img: amazonScraper,
		status: "Finalizado",
		tags: ["Fullstack", "Web Scraping", "Node.js", "Playwright", "HTML", "CSS", "JavaScript", "Express", "Vite"],
		description:
			"Este é um projeto fullstack para web scraping da Amazon, dividido em back-end (Node.js e Playwright para extração de dados) e front-end (HTML, CSS, JavaScript para exibir os resultados). Inclui funcionalidades como detecção de Captcha e paginação dinâmica.",
		link: "https://github.com/RaideriSpace/amazon_scraper_task",
	},
	{
		id: "dev-012",
		title: "Blog Pessoal",
...
export const threedData = [
	...
	},
	{
		...
		img: ecopontoTb,
		status: "Finalizado",
		tags: ["SketchUp", "Sombra", "Comercial", "Ecológico"],
		description: "Descrição do Projeto",
		link: "/",
	},
	{
		...
		img: sugardonutTb,
		status: "Em andamento",
		tags: ["Blender", "Textura", "Sombra", "ColorMap", "Comida", "Jogo"],
		description: "Descrição do Projeto",
		link: "/",
	},
	{
...
export const uxData = [
	{
		...
		description:
			"Proposta: Diminuir o tempo de uso do celular pela metade ao remover o tempo de troca entre aplicativos e diminuindo a redundância de postagens iguais em diferentes redes.",
		link: "/",
	},
	{
		id: "ux-002",
...
export const allProjectsData = [...uiData, ...devData, ...designData, ...paperData, ...threedData, ...uxData];
