...
const Portfolio = () => {
	...
	const currentCategoryInfo = useMemo(() => {
		return categories.find((cat) => cat.name === activeCategory) || categories.find((cat) => cat.name === "all");
	}, [activeCategory]);
			...
			<AnimatePresence mode="wait">
				<motion.div
					...
					{isGeneralPortfolioPage ? null : (
						<GridToRender
							projectsData={activeCategory !== "paper" ? currentCategoryInfo.projectDataKey : undefined}
